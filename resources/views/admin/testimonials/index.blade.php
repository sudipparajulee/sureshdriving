...
@section('content')
    ...
    <div class="py-4 flex-1 px-6 ">
        <div class="border-b-2 border-red-100 dark:border-gray-500">
            <h1 class="text-red-800 dark:text-slate-300 font-bold pt-4 pb-1 px-2 text-3xl">Menu testimonialss</h1>
        </div>
            ...
            <table id="index" class="display dark:text-slate-300 w-full">
                ...
                <tbody class="text-gray-900 dark:text-slate-300">
                    ...
                    <tr class=" border-gray-100 dark:border-gray-600 dark:bg-gray-500">
                        ...
                        <td><img class="w-32" src="/storage/testimonials/{{$testimonial->photopath}}"></td>
                        ...
                        <td>
                            ...
                            <a href="{{ route('testimonials.edit',$testimonial->id) }}" class="py-1 px-4 rounded-md text-white bg-indigo-600 shadow-md shadow-indigo-200 hover:bg-indigo-800 hover:shadow-sm dark:shadow-gray-600">Edit</a>
                            <a href="#" class="py-1 px-4 rounded-md text-white bg-red-500 shadow-md shadow-red-200 hover:bg-red-600 hover:shadow-sm dark:shadow-gray-600" onclick="showdelete({{$testimonial->id}})">Delete</a>
  ...
  <div id="deletemodal"  class="white-card hidden dark:bg-white dark:bg-opacity-10 overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-20 z-50 justify-center items-center md:h-full md:inset-0" >
    <div class="relative px-4 w-full max-w-md h-full md:h-auto mx-auto mt-[15%]">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" method="POST" action="{{ route('testimonials.delete') }}">
              @csrf
  ...
  <div id="data-add-modal"  class="white-card hidden dark:bg-white dark:bg-opacity-10 overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-20 z-50 justify-center items-center md:h-full md:inset-0">
      <div class="relative px-4 w-full max-w-md h-full md:h-auto mx-auto mt-10 mb-10">
          ...
          <div id="data-add-modal-content" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" method="POST" action="{{ route('testimonials.store') }}" enctype="multipart/form-data">
                @csrf
                  <h3 class="text-xl font-medium text-gray-900 dark:text-white">Add New Testimonials</h3>
                  <div>
                      <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Full Name</label>
                      <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{old('name')}}" placeholder="Enter Full Name" required>
                  </div>

                  <div>
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Person Title</label>
                    <input type="text" name="title" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{old('title')}}" placeholder="Enter New title" required>
                </div>

                <div>
                    <label for="comments" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Comments</label>
                    <textarea name="comments" id="comments" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Enter New title" required>{{old('comments')}}</textarea>
                </div>

                  <div class="form-group">
                    <p><input type="file"  accept="image/*" name="photopath" id="file"  onchange="loadFile(event)" style="display: none;"></p>
                    <p class="card shadow"><img id="output" width="246" /></p>
